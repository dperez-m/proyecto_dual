            ...
            <div className="flex flex-row justify-between gap-4 mb-12">
                <div className="flex flex-col items-center text-center w-1/4">
                    ...
                    <div className="w-6 h-6 bg-skylight rounded-full flex items-center justify-center mb-2">
                        <svg className="w-4 h-4 text-darkBlue" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                        </svg>
                    </div>
                    <p className="font-groteske text-sm h-24">
                        Filtra por cada
                        categoría ajustándola a
                ...
                <div className="flex flex-col items-center text-center w-1/4">
                    ...
                    <p className="font-groteske text-sm h-24">
                        Fíjate bien en la
                        serie de iconos que acompaña
                        a cada coche para determinar
                        sus características.
                    </p>
                </div>
                ...
                <div className="flex flex-col items-center text-center w-1/4">
                    ...
                    <p className="font-groteske text-sm h-24">
                        ...
                        y selecciónalo para ver más información.
                    </p>
                </div>
            </div>
